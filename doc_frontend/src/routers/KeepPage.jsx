...
class KeepPage extends Component {
    scrollTop = 0;

    componentDidUpdate() {
        // 完成更新，内容加载完成之后，恢复当前tab页滚动条
        // console.log('keepPage 完成更新，内容加载完成之后，恢复当前tab页滚动条');
    ...
    render() {
        ...
        // console.log('keepPage 始终保持内容的顺序不变，避免React的diff算法，在元素移动时，先删除后创建，导致iframe重新加载的问题', sortTabs);
