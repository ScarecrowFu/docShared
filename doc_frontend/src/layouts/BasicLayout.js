...
import Side from 'src/components/Layouts/Side';
import PageTabs from 'src/components/Layouts/PageTabs';
import {connect} from 'src/models';
import {getLoginUser, getSelectedMenuByPath, setLoginUser} from 'src/utils/user-permission';
